...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* Trust Indicators */}
      <section className="pt-8 md:pt-12 lg:pt-16 pb-4 md:pb-6 lg:pb-8 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 lg:gap-8 items-center opacity-60">
              <div className="bg-gray-100 h-10 md:h-12 rounded-lg flex items-center justify-center px-2">
              ...
              <div className="bg-gray-100 h-10 md:h-12 rounded-lg flex items-center justify-center px-2 col-span-2 md:col-span-1">
                <span className="text-gray-600 font-semibold text-xs md:text-sm text-center">
                  VAT Solutions
                </span>
              </div>
